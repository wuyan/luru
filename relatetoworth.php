<?php
	...
	//删除系统已存关联项
	$sql_sub_d = "delete from report_worth where position_id=$_POST[position_id] and page_id=$_POST[page_id]";
...
//入数据库中插入页面保存数据 
$sql="INSERT INTO report_worth (position_id,page_id,subcompetency_id,title) VALUES ('$_POST[position_id]','$_POST[page_id]','$sub_competency_id_all','$_POST[page_name]')";
mysql_query($sql);
$page_id=$_POST[page_id]+1;
echo "<script>window.location='report_worth.php?position_id=".$_POST[position_id]."&page_id=".$page_id."';</script>";
?>