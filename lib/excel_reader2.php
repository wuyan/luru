...
class Spreadsheet_Excel_Reader {
	...
	function dump($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel',$a) {
		...
		for($row=1;$row<=$this->rowcount($sheet);$row++) {
			...
			if ($row_numbers) {
				...
				$out .="<input type=\"checkbox\" name=\"answer[]\" title=\"$id_zhi\" value=\"$id_zhi\">$row";
				}
				$out .="</th>";                                  ////////////////////////////////////////////////////////////////////////////////////////////////////////序号
			}
