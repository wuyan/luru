...
$i = 0;
$mysql_init = $mysql_init . "user_profile.user_id ,user_profile.shenhe from user_basic,user_profile where user_profile.position_id=$_GET[position_id] and user_profile.user_id=user_basic.user_id and user_profile.shenhe>0 group by user_id ";
