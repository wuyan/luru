...
<chart>
	...
	<chart_border  top_thickness='0' bottom_thickness='2' left_thickness='1' right_thickness='0' />
      ...
      <row>
         <null/>
         	<string>跨部门协作&#x0A;Cross-Functional Cooperation</string>
			<string>发展关系&#x0A;Develop & Maintain Relationship</string>
      </row>
      <row>
	...
	<draw>
		...
		<text  alpha='100' size='15' x='280' y='70' width='300' height='10' h_aligh='center' font="arial"  color='000000'  v_align='borrom'>Score of Teaming & Partnering</text>
		<rect layer='background' x='0' y='0' width='750' height='450' fill_color='ffffff' />
		 <line 
           ...
           />
			...
			<text  alpha='80' size='12' x='180' y='405' width='100' height='10' h_aligh='center' font="楷体"  color='000000'  v_align='borrom' >跨部门协作</text>
			<text  alpha='80' size='12' x='515' y='405' width='100' height='10' h_aligh='center' font="楷体"  color='000000'  v_align='borrom' >发展关系</text>
