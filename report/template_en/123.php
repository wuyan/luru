...
<chart>
      ...
      <row>
		 ...
		 /*
			...
			for($index=0;$index<count($tree);$index++){ 
				$result_score = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=$tree[$index]");
	...
	<draw>
		<text  alpha='100' size='15' x='250' y='50' width='300' height='10' h_aligh='center' font="楷体"  color='000000'  v_align='borrom'  shadow1='shadow1'  bevel='bevel2'  >流程管理与资源运用胜任力得分</text>
		 <line 
