			<table width="287" style="text-align:center;border-collapse:collapse;border:1px solid #F2F2F2;" cellpadding="0" cellspacing="0">
				<tbody>
				<tr height="<?php echo $height;?>">
			...
			<?php  
				...
				elseif($score==1)
				{
				 echo '<img src="tu/三角.png" width="10"/>';
					...
					{
						$avg_long=24*($avg - 0.6);
						 echo '<img src="tu/圆.png" width="10" style="z-index:-111;position:absolute;top:36px; left:'.$avg_long.'px; "/>';
					}
