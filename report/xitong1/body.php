...
// -->
       ...
       标杆得分
		...
		<tr style="height:30px;border:0px solid black;background-color:#D9D9D9;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=1 and position_id=25");
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=1 and position_id=25";
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where position_id='25' and competency_id=1 order by  `score` desc limit 1";
		...
		<tr style="height:30px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=2 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=2 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where competency_id=2  and position_id='25'  order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
		...
		<tr style="height:30px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=3 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=3 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where competency_id=3  and position_id='25'  order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
		...
		<tr style="height:30px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=4 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=4 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where competency_id=4  and position_id='25'  order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
		...
		<tr style="height:30px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=5 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=5 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where competency_id=5  and position_id='25'  order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
		...
		<tr style="height:30px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:183px;">
			<?php 
			$result_score = mysql_query("select * from score_competency where user_id='$row[user_id]' and competency_id=6 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="border:0px solid black;width:183px;">
			<?php 
				$sql_avg ="select avg(`score`) as average from score_competency where competency_id=6 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="border:0px solid black;width:183px;">
			<?php
				$sql_max ="select * from score_competency where competency_id=6  and position_id='25'  order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
      ...
      个人优劣势项
		...
		<tr style="height:150px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:150px;">
			<?php
				$sql_max ="select * from score  where user_id='$row[user_id]' and position_id='25' order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
		...
		<tr style="height:150px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:150px;">
							<?php
				$sql_max ="select * from score where user_id='$row[user_id]' and position_id='25' order by  `score` asc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				$sql_des="select * from sub_competency_list where sub_competency_id ='$row_max[sub_competency_id]'";
				$result_des=mysql_query($sql_des);
	...
	<div class="main" style="height:auto;">
      ...
      流程管理测评结果
		...
		<tr style="height:80px;">
			...
			<?php
			$result_score = mysql_query("select * from score where user_id='$row[user_id]' and sub_competency_id=6 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
			$score=number_format($row_score[score], 0);

			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=6 and position_id='25'";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=6 and position_id='25' order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);


			$result_score1 = mysql_query("select * from score where user_id='$row[user_id]' and sub_competency_id=67");
			$row_score1=mysql_fetch_array($result_score1);
			$score1=number_format($row_score1[score], 0);

			$sql_avg1 ="select avg(`score`) as average from score where sub_competency_id=67 and position_id='25'";
			$result_avg1=mysql_query($sql_avg1);
			$row_avg1=mysql_fetch_array($result_avg1);
			$avg1=$row_avg1[average];

			$sql_max1 ="select * from score  where sub_competency_id=67  and position_id='25' order by  `score` desc limit 1";
			$result_max1=mysql_query($sql_max1);
			$row_max1=mysql_fetch_array($result_max1);
			$max1=number_format($row_max1[score], 0);

			$result_score2 = mysql_query("select * from score where user_id='$row[user_id]' and sub_competency_id=2");
			$row_score2=mysql_fetch_array($result_score2);
			$score2=number_format($row_score2[score], 0);

			$sql_avg2 ="select avg(`score`) as average from score where sub_competency_id=2 and position_id='25'";
			$result_avg2=mysql_query($sql_avg2);
			$row_avg2=mysql_fetch_array($result_avg2);
			$avg2=$row_avg2[average];

			$sql_max2 ="select * from score  where sub_competency_id=2 and position_id='25' order by  `score` desc limit 1";
		...
		<tr style="height:80px;">
			...
			<td style="width:100px;border:0px solid black;background-color:#F2F2F2;">
			 <?php 
			$result_score = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=67 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
		 	echo number_format($row_score[score], 1);
			?>
			</td>
			<td style="width:100px;border:0px solid black;background-color:#F2F2F2;">
			<?php
				$sql_avg ="select avg(`score`) as average from score where sub_competency_id=67 and position_id=25";
				$result_avg=mysql_query($sql_avg);
				$row_avg=mysql_fetch_array($result_avg);
				echo number_format($row_avg[average], 1);
			?>
			...
			<td style="width:100px;border:0px solid black;background-color:#F2F2F2;">
				<?php
				$sql_max ="select * from score  where sub_competency_id=67 and position_id=25 order by  `score` desc limit 1";
				$result_max=mysql_query($sql_max);
				$row_max=mysql_fetch_array($result_max);
				echo number_format($row_max[score], 1);
			?>
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=2 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=2 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0); 
			...
			<td style="width:100px;border:0px solid black;background-color:#F2F2F2;">
			<?php 
			$result_score = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=2 and position_id=25");
			$row_score=mysql_fetch_array($result_score);
		 	echo number_format($row_score[score], 1);
			?>
			</td>
	...
	<div class="main">
      ...
      资源运用测评结果
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=11 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=11 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
			...
			$sql_avg1 ="select avg(`score`) as average from score where sub_competency_id=68 and position_id=25";
			$result_avg1=mysql_query($sql_avg1);
			$row_avg1=mysql_fetch_array($result_avg1);
			$avg1=$row_avg1[average];

			$sql_max1 ="select * from score  where sub_competency_id=68 and position_id=25 order by  `score` desc limit 1";
			$result_max1=mysql_query($sql_max1);
			$row_max1=mysql_fetch_array($result_max1);
			$max1=number_format($row_max1[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=68 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=68 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
			?>
	...
	<div class="main">
      ...
      人员激励测评结果
		...
		<?php
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=45 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=45 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
			...
			$sql_avg1 ="select avg(`score`) as average from score where sub_competency_id=61 and position_id=25";
			$result_avg1=mysql_query($sql_avg1);
			$row_avg1=mysql_fetch_array($result_avg1);
			$avg1=$row_avg1[average];

			$sql_max1 ="select * from score  where sub_competency_id=61 and position_id=25 order by  `score` desc limit 1";
			$result_max1=mysql_query($sql_max1);
			$row_max1=mysql_fetch_array($result_max1);
			$max1=number_format($row_max1[score], 0);

			$result_score2 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=69");
			$row_score2=mysql_fetch_array($result_score2);
			$score2=number_format($row_score2[score], 0);

			$sql_avg2 ="select avg(`score`) as average from score where sub_competency_id=69 and position_id=25";
			$result_avg2=mysql_query($sql_avg2);
			$row_avg2=mysql_fetch_array($result_avg2);
			$avg2=$row_avg2[average];

			$sql_max2 ="select * from score  where sub_competency_id=69 and position_id=25 order by  `score` desc limit 1";
			$result_max2=mysql_query($sql_max2);
			$row_max2=mysql_fetch_array($result_max2);
			$max2=number_format($row_max2[score], 0);
			?>
		...
		<?php 
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=61 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=61 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<?php 
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=69 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=69 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
	...
	<div class="main">
      ...
      团队合作测评结果
		...
		<?php
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=62 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=62 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
			...
			$sql_avg1 ="select avg(`score`) as average from score where sub_competency_id=63 and position_id=25";
			$result_avg1=mysql_query($sql_avg1);
			$row_avg1=mysql_fetch_array($result_avg1);
			$avg1=$row_avg1[average];

			$sql_max1 ="select * from score  where sub_competency_id=63 and position_id=25 order by  `score` desc limit 1";
			$result_max1=mysql_query($sql_max1);
			$row_max1=mysql_fetch_array($result_max1);
			$max1=number_format($row_max1[score], 0);
			...
			$sql_avg2 ="select avg(`score`) as average from score where sub_competency_id=70 and position_id=25";
			$result_avg2=mysql_query($sql_avg2);
			$row_avg2=mysql_fetch_array($result_avg2);
			$avg2=$row_avg2[average];

			$sql_max2 ="select * from score  where sub_competency_id=70 and position_id=25 order by  `score` desc limit 1";
			$result_max2=mysql_query($sql_max2);
			$row_max2=mysql_fetch_array($result_max2);
			$max2=number_format($row_max2[score], 0);
			?>
		...
		<?php 
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=63 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=63 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=70 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=70 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
	...
	<div class="main">
      ...
      自我管理测评结果
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=64 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=64 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);


			$result_score1 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=65");
			$row_score1=mysql_fetch_array($result_score1);
			$score1=number_format($row_score1[score], 0);

			$sql_avg1 ="select avg(`score`) as average from score where sub_competency_id=65 and position_id=25";
			$result_avg1=mysql_query($sql_avg1);
			$row_avg1=mysql_fetch_array($result_avg1);
			$avg1=$row_avg1[average];

			$sql_max1 ="select * from score  where sub_competency_id=65 and position_id=25 order by  `score` desc limit 1";
			$result_max1=mysql_query($sql_max1);
			$row_max1=mysql_fetch_array($result_max1);
			$max1=number_format($row_max1[score], 0);

			$result_score2 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=29");
			$row_score2=mysql_fetch_array($result_score2);
			$score2=number_format($row_score2[score], 0);

			$sql_avg2 ="select avg(`score`) as average from score where sub_competency_id=29 and position_id=25";
			$result_avg2=mysql_query($sql_avg2);
			$row_avg2=mysql_fetch_array($result_avg2);
			$avg2=$row_avg2[average];

			$sql_max2 ="select * from score  where sub_competency_id=29 and position_id=25 order by  `score` desc limit 1";
			$result_max2=mysql_query($sql_max2);
			$row_max2=mysql_fetch_array($result_max2);
			$max2=number_format($row_max2[score], 0);

			$result_score3 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=25");
			$row_score3=mysql_fetch_array($result_score3);
			$score3=number_format($row_score3[score], 0);

			$sql_avg3 ="select avg(`score`) as average from score where sub_competency_id=25 and position_id=25";
			$result_avg3=mysql_query($sql_avg3);
			$row_avg3=mysql_fetch_array($result_avg3);
			$avg3=$row_avg3[average];

			$sql_max3 ="select * from score  where sub_competency_id=25 and position_id=25 order by  `score` desc limit 1";
			$result_max3=mysql_query($sql_max3);
			$row_max3=mysql_fetch_array($result_max3);
			$max3=number_format($row_max3[score], 0);


			$result_score4 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=28");
			$row_score4=mysql_fetch_array($result_score4);
			$score4=number_format($row_score4[score], 0);

			$sql_avg4 ="select avg(`score`) as average from score where sub_competency_id=28 and position_id=25";
			$result_avg4=mysql_query($sql_avg4);
			$row_avg4=mysql_fetch_array($result_avg4);
			$avg4=$row_avg4[average];

			$sql_max4 ="select * from score  where sub_competency_id=28 and position_id=25 order by  `score` desc limit 1";
			$result_max4=mysql_query($sql_max4);
			$row_max4=mysql_fetch_array($result_max4);
			$max4=number_format($row_max4[score], 0);


			$result_score5 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=26");
			$row_score5=mysql_fetch_array($result_score5);
			$score5=number_format($row_score5[score], 0);

			$sql_avg5 ="select avg(`score`) as average from score where sub_competency_id=26 and position_id=25";
			$result_avg5=mysql_query($sql_avg5);
			$row_avg5=mysql_fetch_array($result_avg5);
			$avg5=$row_avg5[average];

			$sql_max5 ="select * from score  where sub_competency_id=26 and position_id=25 order by  `score` desc limit 1";
			...
			$result_score6 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=24 and position_id=25");
			$row_score6=mysql_fetch_array($result_score6);
			$score6=number_format($row_score6[score], 0);

			$sql_avg6 ="select avg(`score`) as average from score where sub_competency_id=24 and position_id=25";
			$result_avg6=mysql_query($sql_avg6);
			$row_avg6=mysql_fetch_array($result_avg6);
			$avg6=$row_avg6[average];

			$sql_max6 ="select * from score  where sub_competency_id=24 and position_id=25 order by  `score` desc limit 1";
			...
			$result_score7 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=43");
			$row_score7=mysql_fetch_array($result_score7);
			$score7=number_format($row_score7[score], 0);

			$sql_avg7 ="select avg(`score`) as average from score where sub_competency_id=43 and position_id=25";
			$result_avg7=mysql_query($sql_avg7);
			$row_avg7=mysql_fetch_array($result_avg7);
			$avg7=$row_avg7[average];

			$sql_max7 ="select * from score  where sub_competency_id=43 and position_id=25 order by  `score` desc limit 1";
			...
			$result_score8 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=58");
			$row_score8=mysql_fetch_array($result_score8);
			$score8=number_format($row_score8[score], 0);

			$sql_avg8 ="select avg(`score`) as average from score where sub_competency_id=58 and position_id=25";
			$result_avg8=mysql_query($sql_avg8);
			$row_avg8=mysql_fetch_array($result_avg8);
			$avg8=$row_avg8[average];

			$sql_max8 ="select * from score  where sub_competency_id=58 and position_id=25 order by  `score` desc limit 1";
			...
			$result_score9 = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=66");
			$row_score9=mysql_fetch_array($result_score9);
			$score9=number_format($row_score9[score], 0);

			$sql_avg9 ="select avg(`score`) as average from score where sub_competency_id=66 and position_id=25";
			$result_avg9=mysql_query($sql_avg9);
			$row_avg9=mysql_fetch_array($result_avg9);
			$avg9=$row_avg9[average];

			$sql_max9 ="select * from score  where sub_competency_id=66 and position_id=25 order by  `score` desc limit 1";
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=65 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=65 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=29 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=29 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<?php 
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=25 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=25 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=28 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=28 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=26 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=26 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=24 and position_id=25 ";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=24 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=43 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=43 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=58 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=58 and position_id=25  order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:80px;">
			...
			$sql_avg ="select avg(`score`) as average from score where sub_competency_id=66 and position_id=25";
			$result_avg=mysql_query($sql_avg);
			$row_avg=mysql_fetch_array($result_avg);
			$avg=$row_avg[average];

			$sql_max ="select * from score  where sub_competency_id=66 and position_id=25 order by  `score` desc limit 1";
			$result_max=mysql_query($sql_max);
			$row_max=mysql_fetch_array($result_max);
			$max=number_format($row_max[score], 0);
		...
		<tr style="height:120px;border:0px solid black;background-color:#F2F2F2;">
			...
			<td style="border:0px solid black;width:600px;text-align:left;">
				<?php 
					$result_score = mysql_query("select * from score where user_id='$_GET[id]' and sub_competency_id=43");
					$row_score=mysql_fetch_array($result_score);
					echo  competency_zh(43, $row_score[score])
				?>
			</td>
		</tr>
		<tr style="height:120px;border:0px solid black;background-color:#F2F2F2;">
