...
<html lang="en">
<head>
    <title id='Description'>子胜任力管理</title>
	...
	<?php 
			...
			$sql_sub_n = "select * from group_sub_competency where group_id=$_GET[id]";
...
<body class='default' style="background-color:#FFF;width: 300px;">
    <form class="form" id="form" target="form-iframe" method="post" action="sub_competency_group.php" style="font-size: 13px; font-family: Verdana;">
                ...
                <ul>
					...
					while ($row=mysql_fetch_array($result)){
						...
						while ($row_sub_n=mysql_fetch_array($result_sub_n)){
									...
									$sql_sub_c = "select * from group_sub_competency where sub_competency_id='$row_sub_n[sub_competency_id]' and group_id=$_GET[id]";
