...
<head>
	...
	<?php 
			...
			$sql_sub_n = "select * from report_attach where position_id=$_GET[position_id] and page_id=$_GET[page_id]";
...
<body class='default' style="background-color:#FFF;width: 300px;">
    <form class="form" id="form"  method="post" action="relatetoattach.php" style="font-size: 13px; font-family: Verdana;">
				...
				<h2><?php echo "第".$_GET[page_id]."胜任力组";?></h2>
					...
					while ($row=mysql_fetch_array($result)){
						...
						while ($row_sub_n=mysql_fetch_array($result_sub_n)){
							...
							if($_GET[page_id]>1){
								$sql_sub_all = "select * from report_attach where position_id=$_GET[position_id] ";
